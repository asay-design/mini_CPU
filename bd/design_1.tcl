...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.Coe_File {c:/Users/lobez/OneDrive - Universidad Politcnica de Madrid/DocumetosD/personal/Proyectos/mini_CPU/Memory/mem_init.coe} \
  ...
  connect_bd_net -net Net  [get_bd_ports clk] \
  ...
  [get_bd_pins controller_0/mem_data_r]
  connect_bd_net -net controller_0_mem_addr  [get_bd_pins controller_0/mem_addr] \
  [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net controller_0_mem_data_w  [get_bd_pins controller_0/mem_data_w] \
  [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net start_0_1  [get_bd_ports start_0] \
  [get_bd_pins controller_0/start]
